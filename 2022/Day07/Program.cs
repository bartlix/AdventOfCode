...
namespace Day07
{
    internal class Programm
    {
        ...
        static void Main(string[] args)
        {
            ...
            var freeSpace = 70000000 - all;

            var nedded = 30000000 - freeSpace;

            bla.Add(new { Name = "/", Size = all });

            var del = bla.Where(x => x.Size >= nedded).OrderBy(x => x.Size).FirstOrDefault();

            Console.WriteLine(del.Size);
            Clipboard.SetText(del.Size.ToString());
